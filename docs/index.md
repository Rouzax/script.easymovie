# Welcome to EasyMovie

**Simplify movie night.**

EasyMovie transforms your Kodi movie library into a personal movie picker. It asks a few quick questions, then presents a curated random selection so you can stop browsing and start watching. Think of it as a movie night concierge that already knows your library.

---

## What Does EasyMovie Do?
...
|------|------------|----------|
| **[Browse Mode](browse-mode.md)** | See a visual grid of curated movies. Pick what catches your eye. | Active choosing |
| **[Playlist Mode](playlist-mode.md)** | One click builds a movie marathon playlist. Sit back and let EasyMovie decide. | Eliminating decision fatigue |

You can choose your preferred mode in settings, or have EasyMovie ask each time.
...
| **[Filter Wizard](filter-wizard.md)** | How the wizard works, filter options, movie counts |
| **[Browse Mode](browse-mode.md)** | Visual browsing, view styles, Re-roll, Surprise Me |
