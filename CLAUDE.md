...
EasyMovie and EasyTV are sibling addons that share a settings vocabulary.
When adding or changing any setting label or help text:

1. **Check the sibling addon** — look at the equivalent setting in `/home/martijn/script.easytv/resources/language/resource.language.en_gb/strings.po`
